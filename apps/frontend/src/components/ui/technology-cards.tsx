  ...
  return (
    ...
    >
      <Link href={link} target="_blank" className="block h-full group focus:outline-none focus-visible:ring-2 focus-visible:ring-violet-500 rounded-lg">
        <Card className="h-full bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm border border-gray-200/50 dark:border-gray-700/50 transition-all duration-300 group-hover:shadow-lg group-hover:border-violet-300 dark:group-hover:border-violet-700 group-hover:-translate-y-1">
