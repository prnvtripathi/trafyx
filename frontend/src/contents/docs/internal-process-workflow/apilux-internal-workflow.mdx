# Internal Process Workflow: Apilux API Testing Framework
...
<div style={{ textAlign: 'center' }}>
  ![Apilux API Testing Workflow](<div style={{ textAlign: 'center' }}>
  ![Apilux API Testing Workflow](../public/apilux-working.png.png)
</div>
)
</div>
...
<div style={{ textAlign: 'center' }}>
  ![Apilux API Testing Workflow](images/apilux-api-workflow.png)
</div>
