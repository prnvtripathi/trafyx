...
This changelog details all changes made to the Apilux project between **10:00 AM IST, November 29, 2024** and **8:30 PM IST, December 1, 2024**.
...
- Created a **"Why Apilux?"** section explaining the benefits and use cases.
...
- Documentation:
  - Comprehensive README with key features and "Why Apilux?"
