---
title: Introduction
description: This section provides an overview of how to get started with Trafix, the AI driven API testing tool.
keywords: ["introduction", "guide", "nextjs", "Trafix"]
---
...
<CardGrid>
  ...
  <Card
    ...
    href="https://github.com/kyrexi/trafix/issues"
    external={true}
  />
</CardGrid>
...
If you have questions about anything related to Trafix, you're always welcome to ask us on [GitHub](https://github.com/kyrexi/trafix)